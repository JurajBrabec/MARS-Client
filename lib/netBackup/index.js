...
class NetBackup extends Command {
  ...
  tickets() {
    this.dbg("tickets");
    const { Nbu2Sm9 } = require("./Nbu2Sm9");
    return new Nbu2Sm9(this);
  }
  esl() {
    this.dbg("esl");
    const { Nbu2Esl } = require("./Nbu2Esl");
    return new Nbu2Esl(this);
  }
  test() {
    return Promise.all([
      this.summary().test(),
...
var nbu = nbu || new NetBackup(process.env.NBU_BIN, process.env.NBU_DATA);
module.exports = { nbu };
