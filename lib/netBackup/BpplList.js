          ...
          dataDefinition: new DataDefinition([
            ...
            },
            {
              ...
              fields: [
                ...
                { fieldName: "extSecInfo", fieldType: "number" },
                ...
                { fieldName: "instantRecovery", fieldType: "number" },
                ...
                { fieldName: "generation", fieldType: "number" },
                { fieldName: "applicationDiscovery", fieldType: "number" },
                { fieldName: "discoveryLifeTime", fieldType: "number" },
                { fieldName: "fastBackup", fieldType: "number" },
                { fieldName: "optimizedBackup", fieldType: "number" },
                { fieldName: "clientListType", fieldType: "number" },
                { fieldName: "selectListType", fieldType: "number" },
                { fieldName: "appConsistent", fieldType: "number" },
                ...
                { fieldName: "include", fieldType: "string" },
                {
                  fieldName: "updated",
                  fieldType: "datetime",
            ...
            },
            {
              ...
              fields: [
                ...
                { fieldName: "field3", fieldType: "number" },
                { fieldName: "field4", fieldType: "number" },
                {
                  fieldName: "updated",
                  fieldType: "datetime",
                  fixedValue: netBackup.now(),
