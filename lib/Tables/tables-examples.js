...
console.log("Buffering?:", Tables.isBuffering());
console.log("Buffering?", Tables.buffer(true).isBuffering());
console.log("Assign:", Tables.assign(values));
console.log("Assign:", Tables.assign(values));
console.log("Assign:", row);
console.log("Buffer:", Tables.buffer());
console.log("Batch:", Tables.batch());
