...
class Parser {
  constructor(options) {
    ...
    const parsing = typeof options === "function" ? options : null;
    ...
    if (options.parsing) this.chain = options.parsing.bind(this);
    if (options.flushing) this.end = options.flushing.bind(this);
  ...
  //END() - override this function in descendant classes
  end = () => {};
