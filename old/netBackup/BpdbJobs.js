...
class BpdbJobsReportDays extends BpdbJobsReport {
  constructor(netBackup, days) {
    const args = ["-t", netBackup.dateDiff(-days)];
    super(netBackup, args);
    this.title = `Reading jobs ${days} days back`;
  }
}
class BpdbJobsReportJobId extends BpdbJobsReport {
  constructor(netBackup, jobId) {
    const args = ["-jobid", jobId];
    super(netBackup, args);
    this.title = `Reading job ID ${jobId}`;
  }
}
class BpdbJobsReportAll extends BpdbJobsReport {
  constructor(netBackup) {
    const args = [];
    super(netBackup, args);
    this.title = `Reading all jobs`;
  }
}
